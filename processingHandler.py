...
def compare_processing_file(procFile):
    diffPath = "bash " + HANDLER_PATH + LOCAL_PROCESS_DIR + "diffProcessing.sh " + HANDLER_PATH + LOCAL_PROCESS_DIR + procFile
...
def change_processing_file(procFile):
    changePath = "bash " + HANDLER_PATH + LOCAL_PROCESS_DIR + "changeProcessing.sh " + HANDLER_PATH + LOCAL_PROCESS_DIR + procFile
