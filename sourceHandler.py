...
def move_source_to_done():
    # new entry in sysParameters for path to files
    pass


# Create a file with the name of the completed ingest folder with prefix "delete_" and a date in 30 days as suffix
# in timestamp format
